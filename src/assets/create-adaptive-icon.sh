...
case "$STYLE" in
    "clear")
        LIGHT_ICON="dynaforge-icon-macOS-ClearLight-1024x1024@2x.png"
        DARK_ICON="dynaforge-icon-macOS-ClearDark-1024x1024@2x.png"
        OUTPUT_NAME="dynaforge-icon-clear-adaptive.icns"
        ;;
    "regular"|"default")
        LIGHT_ICON="dynaforge-icon-macOS-Default-1024x1024@2x.png"
        DARK_ICON="dynaforge-icon-macOS-Dark-1024x1024@2x.png"
        OUTPUT_NAME="dynaforge-icon-regular-adaptive.icns"
        ;;
    "tinted")
        LIGHT_ICON="dynaforge-icon-macOS-TintedLight-1024x1024@2x.png"
        DARK_ICON="dynaforge-icon-macOS-TintedDark-1024x1024@2x.png"
        OUTPUT_NAME="dynaforge-icon-tinted-adaptive.icns"
        ;;
    *)
